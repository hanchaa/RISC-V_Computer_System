...
# common_cells_all component
INCDIR_COMMON_CELLS_ALL=+incdir+$(IP_PATH)/include
SRC_SVLOG_COMMON_CELLS_ALL=\
	$(IP_PATH)/src/binary_to_gray.sv\
	$(IP_PATH)/src/cb_filter_pkg.sv\
	$(IP_PATH)/src/cdc_2phase.sv\
	$(IP_PATH)/src/cf_math_pkg.sv\
	$(IP_PATH)/src/clk_div.sv\
	$(IP_PATH)/src/delta_counter.sv\
	$(IP_PATH)/src/ecc_pkg.sv\
	$(IP_PATH)/src/edge_propagator_tx.sv\
	$(IP_PATH)/src/exp_backoff.sv\
	$(IP_PATH)/src/fifo_v3.sv\
	$(IP_PATH)/src/gray_to_binary.sv\
	$(IP_PATH)/src/isochronous_spill_register.sv\
	$(IP_PATH)/src/lfsr.sv\
	$(IP_PATH)/src/lfsr_16bit.sv\
	...
	$(IP_PATH)/src/stream_intf.sv\
	$(IP_PATH)/src/stream_join.sv\
	$(IP_PATH)/src/stream_mux.sv\
	$(IP_PATH)/src/sub_per_hash.sv\
	$(IP_PATH)/src/sync.sv\
	$(IP_PATH)/src/sync_wedge.sv\
	$(IP_PATH)/src/unread.sv\
	$(IP_PATH)/src/addr_decode.sv\
	$(IP_PATH)/src/cb_filter.sv\
	$(IP_PATH)/src/cdc_fifo_2phase.sv\
	$(IP_PATH)/src/cdc_fifo_gray.sv\
	$(IP_PATH)/src/counter.sv\
	$(IP_PATH)/src/ecc_decode.sv\
	$(IP_PATH)/src/ecc_encode.sv\
	$(IP_PATH)/src/edge_detect.sv\
	$(IP_PATH)/src/lzc.sv\
	$(IP_PATH)/src/max_counter.sv\
	$(IP_PATH)/src/rstgen.sv\
	$(IP_PATH)/src/stream_delay.sv\
	$(IP_PATH)/src/stream_fifo.sv\
	$(IP_PATH)/src/stream_fork_dynamic.sv\
	$(IP_PATH)/src/stream_xbar.sv\
	$(IP_PATH)/src/fall_through_register.sv\
	$(IP_PATH)/src/id_queue.sv\
	$(IP_PATH)/src/stream_to_mem.sv\
	$(IP_PATH)/src/stream_arbiter_flushable.sv\
	$(IP_PATH)/src/stream_omega_net.sv\
