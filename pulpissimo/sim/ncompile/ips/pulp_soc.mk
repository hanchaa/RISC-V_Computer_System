...
# pulp_soc component
INCDIR_PULP_SOC=+incdir+$(IP_PATH)/../../rtl/includes+$(IP_PATH)/rtl/include+$(IP_PATH)/../axi/axi/include
SRC_SVLOG_PULP_SOC=\
	$(IP_PATH)/rtl/pulp_soc/pkg_soc_interconnect.sv\
	$(IP_PATH)/rtl/pulp_soc/axi64_2_lint32_wrap.sv\
	$(IP_PATH)/rtl/pulp_soc/lint_2_axi_wrap.sv\
	$(IP_PATH)/rtl/pulp_soc/contiguous_crossbar.sv\
	$(IP_PATH)/rtl/pulp_soc/interleaved_crossbar.sv\
	$(IP_PATH)/rtl/pulp_soc/tcdm_demux.sv\
	...
	$(IP_PATH)/rtl/pulp_soc/tcdm_error_slave.sv\
